...
* volta.conf: contains configuration settings for voltad or volta-qt
* voltad.pid: stores the process id of voltad while running
...
* debug.log: contains debug information and general logging generated by voltad or volta-qt
