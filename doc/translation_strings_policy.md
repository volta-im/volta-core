...
This document provides guidelines for internationalization of the Volta Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `volta_en.ts` remains unchanged.
