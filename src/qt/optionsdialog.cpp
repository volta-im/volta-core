    ...
    mapper(0)
{
    ...
    ui->voltaAtStartup->setToolTip(ui->voltaAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->voltaAtStartup->setText(ui->voltaAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openVoltaConfButton->setToolTip(ui->openVoltaConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new VoltaUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->voltaAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openVoltaConfButton_clicked()
{
