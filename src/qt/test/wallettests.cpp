...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<VoltaAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_volta-qt -platform xcb      # Linux
//     src/qt/test/test_volta-qt -platform windows  # Windows
//     src/qt/test/test_volta-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = VoltaUnits::formatWithUnit(unit, balance, false, VoltaUnits::separatorAlways);
    ...
    // Amount input
    VoltaAmountField* amountInput = receiveCoinsDialog.findChild<VoltaAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: volta:")) != -1);
