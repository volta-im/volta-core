...
#ifndef VOLTA_QT_VoltaUNITS_H
#define VOLTA_QT_VoltaUNITS_H
...
/** Volta unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VoltaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VoltaUnits(QObject *parent);
...
typedef VoltaUnits::Unit VoltaUnit;

#endif // VOLTA_QT_VoltaUNITS_H
