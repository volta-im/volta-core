...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "2. address      (string, required) The address to send the newly generated Volta to.\n"
...
// NOTE: Unlike wallet RPC (which use XVT values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
