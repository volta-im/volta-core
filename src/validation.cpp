...
#if defined(NDEBUG)
# error "Volta cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Volta Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool test_accept)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s XVT additional fees, %d delta bytes\n",
