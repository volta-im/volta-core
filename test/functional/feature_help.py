...
"""Verify that starting volta with -h works as expected."""
import subprocess

from test_framework.test_framework import VoltaTestFramework
from test_framework.util import assert_equal

class HelpTest(VoltaTestFramework):
    ...
    def run_test(self):
        self.log.info("Start volta with -h for help text")
        ...
        self.log.info("Start volta with -version for version information")
        ...
        self.log.info("Start voltad with -fakearg to make sure it does not start")
