...
# TestP2PConn: A peer we use to send messages to voltad, and store responses.
...
class CompactBlocksTest(VoltaTestFramework):
    ...
    # This test actually causes voltad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that voltad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for voltad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # voltad will not send blocktxn responses for blocks whose height is
